    ...
    <main className="max-w-6xl mx-auto px-6 py-16 font-sans text-slate-900">
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-24 items-center">
        <div className="space-y-8">
          <h2 className="text-3xl font-black text-slate-800 tracking-tight">Sistem Nasıl İşler?</h2>
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <p className="text-slate-600"><strong className="text-slate-900 font-bold">Doğru Ofisi Seçin:</strong> İstanbul ve Ankara ofislerinin yetki alanları farklıdır. İkamet yerinize göre seçim yapmazsanız başvurunuz kabul edilmez.</p>
            </div>
            <div className="flex gap-4">
              ...
              <p className="text-slate-600"><strong className="text-slate-900 font-bold">OTP Doğrulaması:</strong> Kayıt sırasında telefonunuza gelen onay kodunu (OTP) girmek için sadece 2 dakikanız var. Telefonunuzun çekim gücünden emin olun.</p>
            </div>
            <div className="flex gap-4">
              ...
              <p className="text-slate-600"><strong className="text-slate-900 font-bold">Ek Hizmetler:</strong> BLS üzerinden randevu alırken fotokopi, SMS veya kurye gibi hizmetleri önceden seçebilirsiniz.</p>
            </div>
          </div>
        </div>
        <div className="bg-slate-50 p-10 rounded-[3rem] border border-slate-100 shadow-inner">
          ...
          <ul className="space-y-4 text-sm text-slate-500 leading-relaxed">
            <li>• Randevular genellikle haftalık olarak açılır, sistemi Pazartesi sabahları kontrol edin.</li>
      ...
      <section className="mb-24 px-8 py-12 bg-yellow-50 rounded-[4rem] border border-yellow-100">
        <h2 className="text-3xl font-black mb-10 text-center">BLS Sistem Sorunları</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="text-4xl mb-4">📵</div>
            <h4 className="font-bold mb-2">SMS Gelmiyor</h4>
            <p className="text-xs text-slate-500">Operatörünüzün yurt dışından gelen SMS'lere açık olduğunu kontrol edin veya farklı bir numara deneyin.</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">💳</div>
            <h4 className="font-bold mb-2">Ödeme Reddi</h4>
            <p className="text-xs text-slate-500">BLS sistemi bazı banka kartlarını kabul etmeyebilir. Troy yerine Visa veya Mastercard tercih edin.</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">🔄</div>
            <h4 className="font-bold mb-2">Sayfa Donması</h4>
            <p className="text-xs text-slate-500">Başvuru formunu doldururken çok yavaş hareket ederseniz sistem güvenliğiniz için sizi dışarı atar.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 rounded-[3.5rem] p-12 text-center text-white relative shadow-2xl overflow-hidden border-t-8 border-yellow-500">
        <div className="relative z-10">
          <h2 className="text-3xl md:text-5xl font-black mb-6 italic tracking-tight uppercase">İspanya Hayalinizi Ertelemeyin</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <a href="https://wa.me/905302199056" className="bg-yellow-500 text-slate-900 px-12 py-5 rounded-2xl font-black text-xl hover:bg-yellow-400 transition-all transform hover:scale-105 shadow-xl shadow-yellow-500/20">
              Hızlı Randevu & Destek
            </a>
            <a href="/iletisim" className="bg-white/10 text-white px-12 py-5 rounded-2xl font-black text-xl border border-white/20 hover:bg-white/20 transition shadow-lg">
              İletişime Geç
            </a>
          </div>
        </div>
        <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none flex items-center justify-center text-[20rem]">🇪🇸</div>
      </section>
