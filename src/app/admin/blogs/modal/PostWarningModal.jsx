        ...
        <div className="p-6 text-center space-y-6">
          ...
          <p className="text-sm text-gray-500 leading-relaxed">
            {isSuccess
              ...
              : isPuting
              ? "Blog yazısı ekleniyor, lütfen bekleyiniz."
              : "Blog yazısını kaydetmek istiyor musunuz?"}
          </p>
          ...
          {!boolPut.put_now && (
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="cursor-pointer w-full py-2.5 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition flex items-center justify-center gap-2"
              >
                <FaSave size={18} />
                Kaydet
              </button>
