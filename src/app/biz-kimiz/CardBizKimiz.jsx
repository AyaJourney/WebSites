      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-3">
          <span
            ref={addFadeRef}
            data-anim="biz-fade"
            className="biz-fade-init inline-flex w-fit items-center gap-2 px-3 py-1 text-sm font-semibold rounded-full bg-blue-50 text-pink-800 border border-blue-100"
          >
          ...
          <h1
            ref={addFadeRef}
            data-anim="biz-fade"
            className="biz-fade-init text-4xl sm:text-5xl font-bold leading-tight"
          >
          ...
          <p
            ref={addFadeRef}
            data-anim="biz-fade"
            className="biz-fade-init text-gray-600 text-lg leading-relaxed"
          >
          ...
          >
            <Link href="/randevu">
              <button className="px-5 cursor-pointer py-3 rounded-full bg-blue-600 text-white font-semibold shadow-md hover:bg-blue-700 transition">
          ...
          <div className="space-y-3">
            {bullets.map((item, i) => (
              <div
                ...
                ref={addFadeRef}
                data-anim="biz-fade"
                className="biz-fade-init flex items-start gap-3 text-base"
              >
        ...
        <div
          ref={rightCardRef}
          data-anim="biz-card"
          className="biz-card-init relative"
        >
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-blue-100/50 via-white to-purple-100/40 blur-2xl" />

          <div className="relative rounded-3xl border border-gray-100 shadow-xl bg-white/80 backdrop-blur-md p-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              {["Belge kontrolü tamamlandı", "Randevu takibi açık", "Danışman atandı", "Güncel liste paylaşıldı"].map(
                (text, i) => (
                  <div
                    key={i}
