      ...
      (entries) =>
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add("gc-show");
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative w-full h-[80vh] flex items-center justify-center">
        ...
        <div ref={register} className="relative z-10 max-w-4xl px-6 text-center gc-fade">
          ...
          <p className="mt-4 text-lg md:text-xl text-slate-700">
            Yeteneklerinizi dünyaya açmak artık hayal değil. Doğru strateji, doğru hazırlık ve doğru
            yönlendirme ile global rekabetin bir adım önüne geçebilirsiniz.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-6">
        {[
          ...
          <article
            ...
            className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white/95 backdrop-blur p-6 shadow-lg shadow-slate-200 transition hover:-translate-y-1 hover:shadow-emerald-200/60 gc-card gc-scale"
          >
      ...
      <section className="max-w-5xl mx-auto px-6 pb-12 space-y-12">
        <article
          ref={register}
          className="space-y-4 p-6 rounded-3xl border border-slate-200 bg-white/95 backdrop-blur shadow-xl shadow-slate-200 gc-fade-up"
        >
          ...
          <p className="text-slate-700 leading-relaxed">
            Global şirketler önce ATS filtresini uygular, sonra işe alımcılar devreye girer. Temiz
            format, doğru anahtar kelimeler ve hedef ülkenin dilinde akıcı iletişim kritik.
            Mülakatlarda teknik terimlere hakimiyet ve akıcılık, teklif aşamasını belirler.
          </p>
        </article>

        <article
          ref={register}
          className="space-y-4 p-6 rounded-3xl border border-slate-200 bg-white/95 backdrop-blur shadow-xl shadow-blue-200/50 gc-fade-up"
        >
          ...
          <ul className="mt-2 space-y-2 text-slate-700 leading-relaxed">
            <li>
              <strong>LinkedIn:</strong> Global ağ, “Open to Work”, işe alımcı görünürlüğü.
            </li>
            <li>
              <strong>Indeed:</strong> Dünyanın en büyük iş arama motoru, ülke bazlı filtreler.
            </li>
            <li>
              <strong>Glassdoor:</strong> Maaş analizleri, şirket yorumları, mülakat soruları.
            </li>
          </ul>
        </article>
        ...
        <article
          ref={register}
          className="space-y-4 p-6 rounded-3xl border border-slate-200 bg-white/95 backdrop-blur shadow-xl shadow-indigo-200/60 gc-fade-up"
        >
        ...
        <article
          ref={register}
          className="space-y-4 p-6 rounded-3xl border border-slate-200 bg-white/95 backdrop-blur shadow-xl shadow-emerald-200/60 gc-fade-up"
        >
          ...
          <p className="text-slate-700 leading-relaxed">
            İş bulmak sürecin yarısı; diğer yarısı, teklifi yasal oturum iznine çevirmek. Aya
            Journey, evrak kontrolü, randevu ve takipte yanında. Hayal satan sahte ilanlar yerine
            gerçekçi strateji.
          </p>
        </article>
      </section>

      <section ref={register} className="max-w-6xl mx-auto px-6 pb-20 gc-fade-up">
          ...
          <div className="relative p-6 md:p-8 space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={box.title} className="p-5 rounded-2xl bg-white/85 border border-slate-200">
                  <h4 className="font-semibold text-slate-900">{box.title}</h4>
                  <p className="text-sm text-slate-700 mt-1 leading-relaxed">{box.desc}</p>
                </div>
              ))}
            </div>
