        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 bg-white shadow-lg rounded-2xl p-6 w-full max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div ref={dropdownRef} className="relative w-full">
              ...
              <div
                className={`flex items-center rounded-lg border ${formData.phone && !isPhoneValid ? "border-red-500" : "border-gray-300"
                  }`}
              >
                {/* Ülke kodu */}
                <button
      ...
      "
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`w-full sm:w-auto py-3 px-6 rounded-xl font-semibold transition-colors duration-300 ${submitState === "idle"
