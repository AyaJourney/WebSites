...
<main className="max-w-6xl mx-auto px-6 py-16 font-sans">
  ...
  <header className="mb-16 text-center">
    ...
    <h1 className="text-4xl md:text-7xl font-black text-slate-900 mb-6 leading-tight">
      ...
      <span className="text-red-600 italic underline decoration-slate-900 underline-offset-8">
        Analiz & Çözüm
      </span>
    </h1>
    ...
    <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm font-semibold text-slate-600">
  ...
  <section className="grid md:grid-cols-2 gap-8 mb-20">
    <div className="bg-white p-10 rounded-[3rem] border border-slate-200 shadow-sm relative overflow-hidden group">
      ...
      <p className="text-slate-600 leading-relaxed mb-6">
        ...
        Detaylı finansal belge rehberi için{" "}
        <Link href="/birlesik-krallik-vize-evraklari" className="font-semibold hover:text-red-600">
          evrak listesine göz atın
        </Link>.
      </p>
      <div className="text-sm font-bold text-red-600 uppercase tracking-widest italic">
        KRİTİK HATA: Kaynağı belirsiz toplu para yatırmak.
      </div>
    </div>
    ...
    <div className="bg-white p-10 rounded-[3rem] border border-slate-200 shadow-sm relative overflow-hidden group">
      ...
      <p className="text-slate-600 leading-relaxed mb-6">
        ...
        Başvuru sürecini yeniden planlamak için{" "}
        <Link href="/ingiltere-vizesi" className="font-semibold hover:text-blue-600">
          vize rehberini inceleyin
        </Link>.
      </p>
      <div className="text-sm font-bold text-red-600 uppercase tracking-widest italic">
        ÇÖZÜM: Gelir-Gider Dengesi Analizi.
      </div>
    </div>
  </section>
  ...
  <div className="bg-red-50 border-2 border-red-600 p-8 rounded-[3rem] mb-20">
    ...
    <p className="text-red-800 leading-relaxed">
      ...
      Eğer dosyanızda böyle bir şüphe varsa, süreç mutlaka profesyonel yönetilmelidir.
      Ret detaylarını okumak için{" "}
      <Link href="/ingiltere-vize-reddi-nedenleri" className="font-semibold underline">
        İngiltere ret nedenleri sayfasına gidin
      </Link>.
    </p>
  </div>
  ...
  <section className="mb-20">
    <h2 className="text-3xl font-black mb-10 text-center">
      İngiltere Retleri İçin Yol Haritası
    </h2>
    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
        ...
        <p className="text-sm text-slate-500">
          Teknik hata varsa "Administrative Review" başvurusu yapılır.
        </p>
      </div>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
        ...
        <p className="text-sm text-slate-500">
          Eksikleri gidererek fresh application yapılır.
          Yeni başvuru öncesi{" "}
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
        ...
        <p className="text-sm text-slate-500">
          Banka hareketlerinizi İngiltere standartlarına uygun hale getirecek plan oluşturulur.
        </p>
      </div>
    </div>
  </section>
  ...
  <section className="bg-slate-900 rounded-[3rem] p-12 text-center text-white shadow-2xl relative overflow-hidden">
    <div className="relative z-10">
      <h2 className="text-3xl md:text-5xl font-black mb-6 italic tracking-tight uppercase">
        İngiltere Vizenizi Riske Atmayın
      </h2>
  ...
  <nav className="mt-20 border-t border-slate-100 pt-10">
    ...
    <div className="flex flex-wrap gap-4 text-sm font-bold">
      <a href="/schengen-vize-reddi-nedenleri" className="px-5 py-2 bg-slate-50 rounded-lg text-slate-600 hover:text-blue-600 transition">
        🇪🇺 Schengen
      </a>
      <a href="/abd-vize-reddi-nedenleri" className="px-5 py-2 bg-slate-50 rounded-lg text-slate-600 hover:text-blue-600 transition">
        🇺🇸 ABD
      </a>
      <a href="/kanada-vize-reddi-nedenleri" className="px-5 py-2 bg-slate-50 rounded-lg text-slate-600 hover:text-rose-600 transition">
        🇨🇦 Kanada
      </a>
    </div>
  </nav>
