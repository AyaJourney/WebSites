    ...
    <main className="max-w-6xl mx-auto px-6 py-16 font-sans">
      ...
      <section className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-[3rem] p-12 text-center text-white shadow-2xl relative">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <a href="https://wa.me/905302199056" className="bg-white text-emerald-700 px-12 py-5 rounded-2xl font-black text-xl hover:shadow-2xl transition-all transform hover:scale-105">
           Yol Haritası Al
          </a>
