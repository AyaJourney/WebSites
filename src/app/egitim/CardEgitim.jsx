...
<div
  className="
    absolute z-30 
    rounded-full px-6 py-8 
    text-[#2a2a2a] font-semibold
    text-md sm:text-xl md:text-2xl
    whitespace-nowrap
    shadow-[0_0_12px_rgba(255,180,40,0.45)]
    backdrop-blur-md
    flex items-center
    ...
    /* Tablet & Desktop: sağ üst */
    md:top-10 md:left-auto md:right-10 md:-translate-x-0

    transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(255,170,40,0.6)]
  "
>
